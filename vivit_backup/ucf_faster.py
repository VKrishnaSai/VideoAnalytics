...
# ----------------------- Data Preparation -----------------------
def load_data(data_root="/kaggle/input/kinetics4005persplit"):
...
def main():
    ...
    train_dataset = VideoDataset(train_subset_videos, train_subset_labels)
    val_dataset = VideoDataset(val_subset_videos, val_subset_labels)
    test_dataset = VideoDataset(testlist_videos, testlist_labels)
